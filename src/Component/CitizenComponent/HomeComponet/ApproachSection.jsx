...
const ApproachSection = () => {
  ...
  const translations = {
    ENG: {
      ...
      card1Desc: "Systematically identifying and addressing urgent environmental issues to minimize impact and ensure safety.",
      ...
      card3Desc: "Using citizen feedback and data analytics to refine our processes and enhance environmental governance.",
    },
    AMH: {
      ...
      card1Desc: "ተፅዕኖን ለመቀነስ እና ደህንነትን ለማረጋገጥ አስቸኳይ የአካባቢ ጥበቃ ጉዳዮችን በስርዓት መለየት እና ምላሽ መስጠት።",
      ...
      card3Desc: "ሂደቶቻችንን ለማሻሻል እና የአካባቢ ጥበቃ አስተዳደርን ለማጎልበት የዜጎችን ግብረመልስ እና የዳታ ትንታኔን መጠቀም።",
    },
    ORM: {
