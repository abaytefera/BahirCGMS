...
const AboutSection = () => {
  ...
  const translations = {
    ENG: {
      ...
      actionDesc: "Your report can make a real difference. Speak up, stay informed, and help protect our citizens.",
      tag: "About Us",
    ...
    AMH: {
      ...
      actionDesc: "የእርስዎ ሪፖርት እውነተኛ ለውጥ ሊያመጣ ይችላል። ድምፅዎን ያሰሙ፣ መረጃ ያግኙ እና ለመጠበቅ ይርዱ።",
      tag: "ስለ እኛ",
      title: "ለተሳለጠ ግንኙነት የደንበኞች ድጋፍ አገልግሎት ነን",
      desc1: "የዜጎችን ድምፅ በመስማት፣ በኃላፊነት ስሜት ምላሽ በመስጠት እና ጥበቃ ህጎች ግልፅ እና ቀልጣፋ በሆነ የአገልግሎት አሰጣጥ መከበራቸውን በማረጋገጥ ለመጠበቅ ቆርጠን ተነስተናል።",
      desc2: "የቅሬታ እና አቤቱታ ማስተዳደሪያ ስርዓት (CGMS) የህዝብ ተደራሽነትን፣ ተጠያቂነትን እና በአካባቢ አስተዳደር ላይ ተሳትፎን ለማሻሻል በኢትዮጵያ ጥበቃ ባለስልጣን የተዘጋጀ ይፋዊ የዲጂታል አገልግሎት ነው።",
